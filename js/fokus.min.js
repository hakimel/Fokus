...
B++){var A=z[B];if(A.nodeName==="#text"&&A.nodeValue.trim()){A=A.parentNode;}var D=a(A);var G=D.x,F=D.y,H=A.offsetWidth,C=A.offsetHeight;if(A&&typeof G==="number"&&typeof H==="number"&&!A.nodeName.match(/^br$/gi)){b.left=Math.min(b.left,G);
